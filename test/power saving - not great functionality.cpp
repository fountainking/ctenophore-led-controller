...
<body>
    ...
    <script>
        ...
        function startPolling() {
            ...
            }, 500); // Faster polling for more responsive LED updates
        }
...
void updateLEDs() {
 ...
 static unsigned long lastLEDUpdate = 0;
  ...
  // Only update LEDs at 30 FPS instead of constantly
  if (currentTime - lastLEDUpdate < 33) return;  // ~30 FPS
...
void setup() {
  ...
  pm_config.max_freq_mhz = 80;          // Max CPU frequency
  pm_config.min_freq_mhz = 10;           // Min CPU frequency  
  pm_config.light_sleep_enable = true;  // DISABLE automatic sleep
